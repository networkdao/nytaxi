...
if __name__ == '__main__':
    ...
    # 包含新增的status 列的dataframe
    sqlDF201301_2 = sqlDF201301_1.withColumn("status", status_function_udf((sqlDF201301_1['totaltime'])/3600))

    #把最终的结果写入到mysql
    sqlDF201301_2.write.format('jdbc').options(url='jdbc:mysql://172.20.x.x:3306/nytaxi?useUnicode=true&characterEncoding=utf8', useSSL="false",\
driver='com.mysql.jdbc.Driver',dbtable='nytaxistaus201301',user='user1',password='********').mode('append').save()
